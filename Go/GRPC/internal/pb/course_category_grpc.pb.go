...
const (
	...
	CategoryService_CreateCategoyStream_FullMethodName               = "/pb.CategoryService/createCategoyStream"
	...
	CategoryService_FindCategoryById_FullMethodName                  = "/pb.CategoryService/findCategoryById"
)
...
type CategoryServiceClient interface {
	...
	CreateCategoyStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateCategoryRequest, CategoryList], error)
	...
	FindCategoryById(ctx context.Context, in *CategoryIdRequest, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) CreateCategoyStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[CreateCategoryRequest, CategoryList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[0], CategoryService_CreateCategoyStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type CategoryService_CreateCategoyStreamClient = grpc.ClientStreamingClient[CreateCategoryRequest, CategoryList]
...
func (c *categoryServiceClient) FindCategoryById(ctx context.Context, in *CategoryIdRequest, opts ...grpc.CallOption) (*Category, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	CreateCategoyStream(grpc.ClientStreamingServer[CreateCategoryRequest, CategoryList]) error
	...
	FindCategoryById(context.Context, *CategoryIdRequest) (*Category, error)
...
func (UnimplementedCategoryServiceServer) CreateCategoyStream(grpc.ClientStreamingServer[CreateCategoryRequest, CategoryList]) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoyStream not implemented")
}
...
func (UnimplementedCategoryServiceServer) FindCategoryById(context.Context, *CategoryIdRequest) (*Category, error) {
...
func _CategoryService_CreateCategoyStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoyStream(&grpc.GenericServerStream[CreateCategoryRequest, CategoryList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoyStreamServer = grpc.ClientStreamingServer[CreateCategoryRequest, CategoryList]
...
func _CategoryService_FindCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).FindCategoryById(ctx, req.(*CategoryIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "createCategoyStream",
			Handler:       _CategoryService_CreateCategoyStream_Handler,
			ClientStreams: true,
		},
		{
